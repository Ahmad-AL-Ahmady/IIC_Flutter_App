...
void ShowMessage(BuildContext context) {
  ...
  final alert = AlertDialog(
    title: Text("تم"),
    content: Text("تم دفع خدمة الكهرباء"),
  );
...
class _ElectricityState extends State<Electricity> {
  ...
  void initState() {
    ...
    SharedPreferences.getInstance().then((prefs) {
      if (prefs.getStringList("electricity") != null) {
        if (prefs.getStringList("electricity")!.isNotEmpty) {
          setState(() {
            servicesNeedsPayment = true;
            services = prefs.getStringList("electricity")!;
            value = services[0];
          });
        }
      }
                                  ...
                                  Padding(
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: ElevatedButton(
                                        onPressed: () async {
                                          if (ElectricityKey.currentState!
                                              .validate()) {
                                            int _amount =
